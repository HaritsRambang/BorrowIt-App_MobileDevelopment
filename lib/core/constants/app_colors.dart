...
/// Color palette from Kindred Exchange design system
class AppColors {
  // Primary — Evergreen
  ...
  // Secondary — Skyward Blue
  static const Color secondary = Color(0xFF005FAD);
  static const Color onSecondary = Color(0xFFFFFFFF);
  static const Color secondaryContainer = Color(0xFF58A3FE);
  static const Color onSecondaryContainer = Color(0xFF003869);
  ...
  static const Color onSecondaryFixedVariant = Color(0xFF004884);

  // Tertiary — Warm Amber
  static const Color tertiary = Color(0xFF693D00);
  static const Color onTertiary = Color(0xFFFFFFFF);
  static const Color tertiaryContainer = Color(0xFF8A5200);
